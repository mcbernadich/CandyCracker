...
parser.add_argument("-s","--single",type=int,help="Single jump mode. Useful for semi-manual operations. Specify the desired jump i chronological order, starting by 0. ('-1' for zero, because argparse is stupid and doesn't know how to read '0')")
